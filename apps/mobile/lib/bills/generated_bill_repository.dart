  ...
  Future<SettleoraBillDetail> getPersonalBill(String billId) {
    ...
    if (trimmedBillId.isEmpty) {
      throw const SettleoraBillFailure(
        ...
        message: 'Choose a bill before opening details.',
      );
    }
...
SettleoraBillSummary _mapSummary(
...
SettleoraBillDetail _mapDetail(api.PersonalBillResponse response) {
  return SettleoraBillDetail(
    ...
    createdAtUtc: response.createdAtUtc.toUtc(),
    updatedAtUtc: response.updatedAtUtc.toUtc(),
    items: response.items.map(_mapItem).toList(growable: false),
...
SettleoraBillItem _mapItem(api.PersonalBillItemResponse response) {
...
SettleoraBillParticipant _mapParticipant(
...
SettleoraBillPayer _mapPayer(api.PersonalBillPayerResponse response) {
...
SettleoraBillAdjustment _mapAdjustment(
