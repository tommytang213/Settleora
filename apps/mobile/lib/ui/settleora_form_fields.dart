...
const settleoraSupportedCurrencies = <SettleoraCurrencyMetadata>[
  ...
  SettleoraCurrencyMetadata('AED', 'UAE Dirham', minorUnitDigits: 2),
  SettleoraCurrencyMetadata('AUD', 'Australian Dollar', minorUnitDigits: 2),
  SettleoraCurrencyMetadata('BRL', 'Brazilian Real', minorUnitDigits: 2),
  SettleoraCurrencyMetadata('CAD', 'Canadian Dollar', minorUnitDigits: 2),
  SettleoraCurrencyMetadata('CHF', 'Swiss Franc', minorUnitDigits: 2),
  SettleoraCurrencyMetadata('CNY', 'Chinese Yuan', minorUnitDigits: 2),
  SettleoraCurrencyMetadata('INR', 'Indian Rupee', minorUnitDigits: 2),
  SettleoraCurrencyMetadata('KRW', 'South Korean Won', minorUnitDigits: 0),
  SettleoraCurrencyMetadata('MXN', 'Mexican Peso', minorUnitDigits: 2),
  SettleoraCurrencyMetadata('NOK', 'Norwegian Krone', minorUnitDigits: 2),
  SettleoraCurrencyMetadata('NZD', 'New Zealand Dollar', minorUnitDigits: 2),
  SettleoraCurrencyMetadata('PKR', 'Pakistani Rupee', minorUnitDigits: 2),
  SettleoraCurrencyMetadata('PLN', 'Polish Zloty', minorUnitDigits: 2),
  SettleoraCurrencyMetadata('RUB', 'Russian Ruble', minorUnitDigits: 2),
  SettleoraCurrencyMetadata('SEK', 'Swedish Krona', minorUnitDigits: 2),
  SettleoraCurrencyMetadata('SGD', 'Singapore Dollar', minorUnitDigits: 2),
  SettleoraCurrencyMetadata('THB', 'Thai Baht', minorUnitDigits: 2),
  SettleoraCurrencyMetadata('TRY', 'Turkish Lira', minorUnitDigits: 2),
  SettleoraCurrencyMetadata('TWD', 'New Taiwan Dollar', minorUnitDigits: 2),
  SettleoraCurrencyMetadata('VND', 'Vietnamese Dong', minorUnitDigits: 0),
];
