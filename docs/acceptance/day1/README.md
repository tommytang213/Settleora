...
- [Day 1 acceptance evidence and hard-gated gaps](DAY1_ACCEPTANCE_EVIDENCE_AND_GAPS.md)
- [Day 1 manual UI retest checklist](DAY1_MANUAL_UI_RETEST_CHECKLIST.md)
- [Day 1 manual code review checklist](DAY1_MANUAL_CODE_REVIEW_CHECKLIST.md)
