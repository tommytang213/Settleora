...
| H05 | Current TrueNAS install/upgrade/rollback | `blocked` | historical #483 install/update subset | No current-baseline upgrade, backup/restore, rollback, or auth/mobile smoke; R11 must first stabilize broker persistence and R12 must provide an approved reachable private-mobile transport | R05 owns acceptance after R11/R12/R04; #975 consumes it |
