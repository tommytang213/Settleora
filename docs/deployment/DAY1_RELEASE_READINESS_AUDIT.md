...
| B05 | TrueNAS/LAN image package | `implemented` | `infra/docker-compose.truenas-lan.image.yml`; `tools/truenas-catalog/render.mjs` | The legacy image Compose remains operator-selectable; the R04 catalog materializer separately requires semantic R03 identity plus a detached expected digest and selects immutable Linux/amd64 API/PostgreSQL/RabbitMQ/Caddy identities | Completed R03/R04; publication and live selection remain manual |
