...
| B04 | TrueNAS/LAN source-build package | `implemented` | `infra/docker-compose.truenas-lan.yml`; `infra/truenas-catalog/settleora/` | LAN Compose and the unpublished skeleton provide first-class migration gating, exact-host private HTTPS, private dependencies, and deterministic direct/official render validation. Historical #483 live evidence is not current-head install proof | Completed R04; R05 retains live acceptance |
