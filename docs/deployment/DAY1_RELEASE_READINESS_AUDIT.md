...
| User web | Vite plus R02 canonical manifest | Final-main R03 output: three files/426,988 bytes, tree digest `sha256:6bf6cd64...`, bound to source/tree and lock digest | Web-affecting PR artifacts retain staged output/manifest for 14 days; final R03 output is retained inside the external candidate | Exact-source build/provenance implemented; serving, product completeness and protected-push packaging remain incomplete |
