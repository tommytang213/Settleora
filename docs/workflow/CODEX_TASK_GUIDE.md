...
- Generic public file APIs, receipt upload/download runtime, OCR runtime, recurring bills, forecasting, reconciliation, broader residual finalization/credit-ledger behavior beyond payment-claim-time proposals and receiver residual confirmation, broader audit UI/export/retention cleanup, mobile/web/admin product UI, and OCR worker runtime are still not implemented beyond placeholders or starter state.
