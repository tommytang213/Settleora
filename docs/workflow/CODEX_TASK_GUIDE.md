...
- Generic public file APIs, receipt upload/download runtime, OCR runtime, recurring bills, forecasting, reconciliation, residual runtime beyond the internal policy decision foundation, broader audit UI/export/retention cleanup, mobile/web/admin product UI, and OCR worker runtime are still not implemented beyond placeholders or starter state.
