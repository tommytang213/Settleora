...
| P03 | 004-007 | Separate bill-readout, detail, create and lifecycle/edit children under [#344](https://github.com/tommytang213/Settleora/issues/344) | `web-user-ui`; contract child first where needed | `web-ui`; strong; money gate | P01; #344, #346, #349-#352 and #967 before UI where their contracts are incomplete; close only with server-authoritative item rows, resolved split/allocation and adjustment detail, activity plus empty/unavailable states, category, optional bill payment-method field, bill/shared notes and comments, multi-payer/on-behalf confirmation, bill/item split modes and exclusions, quantity assignment/open self-claim, multi-tax/fee/discount/refund/mismatch controls, manual FX, lifecycle operations, safe retry/no-duplicate, refresh and visual proof | #346/#349-#352/#967 own the accepted money/domain and missing detail/metadata/discussion boundaries; #350/#967 specifically own persisted self-claim/unresolved depth, and #582 summary runtime is credited. |
