...
- Source: PR #1169 provides the Flutter 3.44.8 English catalog-generation seam, Android `app_name`, and iOS English `InfoPlist.strings`; application evidence remains [DateField](../../apps/mobile/lib/ui/settleora_form_fields.dart), [_formatProductDate](../../apps/mobile/lib/ui/settleora_form_fields.dart), [SettleoraBillFailureKind](../../apps/mobile/lib/bills/bill_repository.dart), and [SettleoraNotificationScreen](../../apps/mobile/lib/notifications/notification_screen.dart).
...
- Owner: completed audit authority [#409](https://github.com/tommytang213/Settleora/issues/409). `L10N-D1-014` is ready through #1168/PR #1169, including exact-copy native privacy resources and successful iOS-simulator packaging. Remaining: `L10N-D1-001` application catalog/bootstrap and notification-key retention next, then separately bounded `002`/`003`/`004`/`011`/`018`/`021`/`022`/`023`/`026` work. The row stays `partial`: no Dart application copy was migrated, no multilingual or Traditional Chinese runtime exists, and #975 retains final native device/platform acceptance. #301 owns components, not localization.
