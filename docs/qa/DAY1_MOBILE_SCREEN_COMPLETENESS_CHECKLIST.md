...
- Source: PR #1169 provides the Flutter 3.44.8 English catalog-generation seam, Android `app_name`, and iOS English `InfoPlist.strings`. #1171 / PRs #1172-#1174 add the current notification-key catalog, importable ignored generated output, application-root generated delegates/exact `en` locale/`appTitle`, and [notification key retention plus safe resolution](../../apps/mobile/lib/notifications/notification_localization.dart). Other evidence remains [DateField](../../apps/mobile/lib/ui/settleora_form_fields.dart), [_formatProductDate](../../apps/mobile/lib/ui/settleora_form_fields.dart), and [SettleoraBillFailureKind](../../apps/mobile/lib/bills/bill_repository.dart).
- Tests: [app_localization_bootstrap_test.dart](../../apps/mobile/test/app_localization_bootstrap_test.dart), [notification_localization_test.dart](../../apps/mobile/test/notification_localization_test.dart), [notification_generated_repository_test.dart](../../apps/mobile/test/notification_generated_repository_test.dart), and [notification_localization_visual_capture_test.dart](../../apps/mobile/test/ui/notification_localization_visual_capture_test.dart) prove generated bootstrap/title, exact list/read/archive key retention, current known-key resolution, `safeSummary` precedence, unknown-key non-disclosure, and production-widget 390px/1x plus 320px/2x captures. Existing shared-layout and server-writer tests remain adjacent evidence, not translated-runtime acceptance.
...
- Accessibility/visual: Four #1171 production `SettleoraNotificationScreen` captures show known and unknown key behavior, safe summary and detail-sheet states with no raw key, clipping or overflow; existing 48dp/action semantics were unchanged. Pseudolocale/text-expansion, locale formatting and accessible translated labels remain unproven outside this bounded representative feature.
- Owner: completed audit authority [#409](https://github.com/tommytang213/Settleora/issues/409). `L10N-D1-014` is ready through #1168/PR #1169 and `L10N-D1-001` is ready through #1171/PRs #1172-#1174. Remaining separately bounded findings are `002`/`003`/`004`/`011`/`018`/`021`/`022`/`023`/`026`; #973/`019` retains typed dynamic notification-template arguments. The row stays `partial`: broad Dart application copy and formatting remain incomplete, no multilingual or Traditional Chinese runtime exists, and #975 retains final native device/platform acceptance. #301 owns components, not localization.
