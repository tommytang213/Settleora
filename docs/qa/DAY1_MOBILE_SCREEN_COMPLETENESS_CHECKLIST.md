...
- Accessibility/visual: Shared controls, deterministic keyboard submit, non-duplicative status/error semantics, 48dp+ Save target and scroll reachability are covered by widget tests and 12 production-widget captures at 390px/1× and 320px/2×. Paths/hashes are in [Issue #1096 evidence](evidence/issue-1096/README.md). Native device/IME/screen-reader acceptance remains #975/M50.
