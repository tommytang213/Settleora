...
- Owner: [#402](https://github.com/tommytang213/Settleora/issues/402). Remaining: Server review, propose/revise/submit/withdraw/approve/reject/payer actions exist. ApplyBillRevisionAsync already invokes ExpenseBillRevisionSettlementApplyPolicy; requested-only or progressed settlement state conservatively blocks apply without mutation, as the endpoint tests prove. Do not recreate these guards. Full granular snapshots remain incomplete. The generated getBillRevisionSettlementImpact transport has no mapped API endpoint in current source; _mapRevision also drops response.settlementImpact. #402 owns impact-readout runtime/contract reconciliation and mobile wiring, separately from future domain policy for settlement invalidation, adjustment or reopening. A generated method is not callable API runtime, and clients must not calculate settlement impact.
...
- Source: [ImagePickerReceiptImageIntake](../../apps/mobile/lib/receipt_ocr_capture/receipt_image_intake.dart); [ReceiptImageArtifactProcessor](../../apps/mobile/lib/receipt_ocr_capture/receipt_image_artifact_processor.dart); [_processedReceiptAttachmentArtifact](../../apps/mobile/lib/bills/bill_list_screen.dart); [BillAttachmentSection](../../apps/mobile/lib/bills/bill_attachment_section.dart).
