...
- Owner: [#366](https://github.com/tommytang213/Settleora/issues/366). Remaining: Create/edit and pause/resume/archive already exist. Advanced split/payer/adjustment editing is explicitly unavailable; preserve existing payload and gate richer edit scope.
...
- Source: [SettleoraProfileScreen](../../apps/mobile/lib/profile/profile_screen.dart); [_QrStatus](../../apps/mobile/lib/profile/profile_screen.dart).
...
- Owner: [#966](https://github.com/tommytang213/Settleora/issues/966). Remaining: Profile fields/handle/visibility edit exists. QR add/replace/remove/content mobile UI is absent; [#395](https://github.com/tommytang213/Settleora/issues/395) is parent reconciliation, not a second QR owner.
