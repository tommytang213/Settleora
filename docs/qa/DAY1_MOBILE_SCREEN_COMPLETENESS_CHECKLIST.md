...
- Tests: [setup_screen_test.dart](../../apps/mobile/test/setup_screen_test.dart): `server setup starts unverified even with saved configuration`, `unverified server save probes once then saves once`, `save failure retains verified URL and retry does not re-probe`, and `local mode never probes and save failure is retryable`; [server_connection_probe_test.dart](../../apps/mobile/test/server_connection_probe_test.dart): typed success/ignored bootstrap state and safe timeout/transport/API/malformed failure mapping; [widget_test.dart](../../apps/mobile/test/widget_test.dart): production bootstrap persistence success/failure and saved-session non-verification coverage.
- States: E initial Local/Server choice with server unverified; L one checking/save flight; R URL validation plus bounded probe/persistence failure and retry with retained input; D unavailable/incompatible-safe feedback without raw details or bootstrap/account inference; O local choice persists, operational workspace M02. Verification is bound only to the exact normalized URL after the anonymous generated bootstrap-status check.
- Accessibility/visual: Shared controls, deterministic keyboard submit, non-duplicative status/error semantics, 48dp+ Save target and scroll reachability are covered by widget tests and 12 production-widget capture files (11 distinct bitmaps) at 390px/1× and 320px/2×. Paths/hashes and the intentionally identical unchanged failure/retry-ready state are in [Issue #1096 evidence](evidence/issue-1096/README.md). Native device/IME/screen-reader acceptance remains #975/M50.
- Owner: [#1096](https://github.com/tommytang213/Settleora/issues/1096), completed by implementation PR #1154 plus same-task ledger/checklist/evidence hygiene. `GET /api/v1/auth/bootstrap/status` is consumed anonymously through the existing generated client only as a typed Settleora compatibility response; `bootstrapRequired` is ignored. Local Mode stays probe-free. Persistence retry does not repeat a successful check for the unchanged URL, and the configuration-write/session-clear order is unchanged. #301 owns only remaining reusable-component adoption; local workspace remains M02/#971 and experience modes remain M45/#412.
- Gate/dependency: Focused behavior complete. Remaining native/platform acceptance: **W5 / #975**.
...
- Source: [app_en.arb](../../apps/mobile/l10n/app_en.arb); [SettleoraBundledVersionNotes](../../apps/mobile/lib/app/version_notes.dart); [SettleoraVersionNotesAutoPresenter](../../apps/mobile/lib/app/version_notes.dart); [SettleoraAppBootstrap](../../apps/mobile/lib/app/app_bootstrap.dart); [_AppSettingsScreen](../../apps/mobile/lib/app/server_mode_shell.dart). The current built-in bundle uses an explicit typed catalog source and resolves its five payload messages from generated `AppLocalizations` only at presentation time; injected bundles remain caller-owned static content.
- Tests: [version_notes_test.dart](../../apps/mobile/test/version_notes_test.dart): exact generated heading/description/three points, raw-identifier exclusion, catalog-resolution fail-open, unseen/seen/new-version, injected changed-key content, ordinary and explicit dismissal, manual/automatic race, malformed payload/preference, read/write failure, setup/sign-in/local/authenticated settings, focus, zero repository calls and 320px/2× behavior; [version_notes_visual_capture_test.dart](../../apps/mobile/test/ui/version_notes_visual_capture_test.dart): production-widget setup, sign-in, local-only, settings/reopen, current catalog DPR2 and retained expanded-content 2× text-scale captures; [settleora_component_guardrail_test.dart](../../apps/mobile/test/ui/settleora_component_guardrail_test.dart): shared guidance/sheet semantics and narrow scaled layout.
...
- Accessibility/visual: Shared guidance heading semantics and single shared Close action; 48dp+ action targets; actionable settings/local launcher focus restoration; 390px/1× automatic/manual states, 320px/DPR2 exact current catalog content, and retained 320px/2× expanded injected content remain readable and scrollable with Close reachable. Native screen-reader/device acceptance remains #975.
- Owner: [#1092](https://github.com/tommytang213/Settleora/issues/1092), completed by implementation PR #1148 plus same-task ledger hygiene, remains the behavior owner. #1176 / catalog PR #1177 and application PR #1178 separately complete `L10N-D1-021` for the five current English payload strings; #1181 / PRs #1182-#1183 separately complete contextual-help extraction `L10N-D1-022`. The explicit `1.0.0+1` bundled release key must be updated with `pubspec.yaml` for a future release that should present new notes. Future release content and actual translation remain separate; server announcements remain #1094.
...
- Source: [app_en.arb](../../apps/mobile/l10n/app_en.arb); [contextual_help.dart](../../apps/mobile/lib/help/contextual_help.dart); [SettleoraSetupScreen](../../apps/mobile/lib/app/setup_screen.dart); [_ServerHomeScreen and _AppSettingsScreen](../../apps/mobile/lib/app/server_mode_shell.dart); [SettleoraBillListScreen](../../apps/mobile/lib/bills/bill_list_screen.dart); [ReceiptOcrReviewQueueScreen and ReceiptOcrReviewDetailScreen](../../apps/mobile/lib/receipt_ocr_review/receipt_ocr_review_screen.dart); [SettleoraGroupListScreen](../../apps/mobile/lib/groups/group_list_screen.dart); [SettleoraSettlementListScreen](../../apps/mobile/lib/settlements/settlement_list_screen.dart); [SettleoraRecurringBillScreen](../../apps/mobile/lib/recurring_bills/recurring_bill_screen.dart); [SettleoraMonthlyReportScreen](../../apps/mobile/lib/reports/monthly_report_screen.dart). #1181 separates stable topic/version metadata from an explicit generated-`AppLocalizations` display resolver; no competing production English payload remains.
- Tests: [contextual_help_localization_test.dart](../../apps/mobile/test/contextual_help_localization_test.dart), [contextual_help_candidate_a_test.dart](../../apps/mobile/test/contextual_help_candidate_a_test.dart), [contextual_help_candidate_b_test.dart](../../apps/mobile/test/contextual_help_candidate_b_test.dart) and [contextual_help_candidate_c_test.dart](../../apps/mobile/test/contextual_help_candidate_c_test.dart): exact ten-key metadata registry, all 70 catalog fields and 30 ordered points, entry-label extraction, generic `Close help` exclusion, no duplicate English/raw key, screen/topic wiring, implemented/unavailable meanings, zero repository/domain side effects, dismiss/reopen/focus, no persistence or #1092 release-state coupling, backup-preview placement and OCR deletion concurrency; candidate [A](../../apps/mobile/test/ui/contextual_help_candidate_a_visual_capture_test.dart), [B](../../apps/mobile/test/ui/contextual_help_candidate_b_visual_capture_test.dart) and [C](../../apps/mobile/test/ui/contextual_help_candidate_c_visual_capture_test.dart) production-widget capture suites use the real generated localization delegates.
...
- Accessibility/visual: Stable `contextual-help-<topic-key>` action keys, catalog-backed tooltip/semantic labels, 48dp+ launcher/action targets, one guidance heading identity, one explicit generic `Close help` action, natural sheet reading order and reusable focus return. The 27 original #1093 captures remain behavior authority; #1181 regenerated 39 production-widget captures across all Candidate A/B/C surfaces with exact catalog English, 390px/1× breadth, 320px/2× Bills/OCR/Groups/Settlements/Settings coverage, reachable Close and visible focus-after-close. Native screen-reader/device acceptance remains #975.
- Owner: [#1093](https://github.com/tommytang213/Settleora/issues/1093), completed by implementation PRs #1150, #1151 and #1152 plus same-task ledger/evidence hygiene, remains the behavior owner. #1181 / catalog PR #1182 and application PR #1183 separately complete `L10N-D1-022` resource extraction. Exact keys remain `first-launch`, `dashboard`, `bills`, `ocr-review`, `groups`, `settlements`, `recurring`, `reports-search`, `backup-restore` and `settings-security`, all at `2026-09-08.1`. Mobile has no admin-maintenance destination, so it is intentionally not a key; separately approved admin guidance remains #964. This remains distinct from #412 recommendations and #1092 release seen-state.
- Gate/dependency: Feature-complete in scoped Flutter source/tests/evidence and English catalog ownership. #975 retains native/platform acceptance; actual translation remains Day 2.
...
- Source: PR #1169 provides the Flutter 3.44.8 English catalog-generation seam, Android `app_name`, and iOS English `InfoPlist.strings`. #1171 / PRs #1172-#1174 add the current notification-key catalog, importable ignored generated output, application-root generated delegates/exact `en` locale/`appTitle`, and [notification key retention plus safe resolution](../../apps/mobile/lib/notifications/notification_localization.dart). #1176 / PRs #1177-#1178 add the five current What's New payload messages and [presentation-time catalog resolution](../../apps/mobile/lib/app/version_notes.dart) without changing release/seen identity. #1181 / PRs #1182-#1183 add all 70 ten-topic contextual-help messages and [presentation-time catalog resolution](../../apps/mobile/lib/help/contextual_help.dart) without changing topic/version identity or #1093 mechanics. Other evidence remains [DateField](../../apps/mobile/lib/ui/settleora_form_fields.dart), [_formatProductDate](../../apps/mobile/lib/ui/settleora_form_fields.dart), and [SettleoraBillFailureKind](../../apps/mobile/lib/bills/bill_repository.dart).
- Tests: [app_localization_bootstrap_test.dart](../../apps/mobile/test/app_localization_bootstrap_test.dart), [notification_localization_test.dart](../../apps/mobile/test/notification_localization_test.dart), [notification_generated_repository_test.dart](../../apps/mobile/test/notification_generated_repository_test.dart), [notification_localization_visual_capture_test.dart](../../apps/mobile/test/ui/notification_localization_visual_capture_test.dart), [version_notes_test.dart](../../apps/mobile/test/version_notes_test.dart), [version_notes_visual_capture_test.dart](../../apps/mobile/test/ui/version_notes_visual_capture_test.dart), [contextual_help_localization_test.dart](../../apps/mobile/test/contextual_help_localization_test.dart), the Candidate A/B/C behavior tests and their visual capture suites prove generated bootstrap/title, exact list/read/archive key retention, current known-key resolution, `safeSummary` precedence, unknown-key non-disclosure, exact current What's New and contextual-help payload resolution, custom-note compatibility, catalog fail-open, OCR-race preservation, focus restoration, and production-widget 390px/1x plus 320px/2x evidence. Existing shared-layout and server-writer tests remain adjacent evidence, not translated-runtime acceptance.
...
- Accessibility/visual: Four #1171 production `SettleoraNotificationScreen` captures show known and unknown key behavior, safe summary and detail-sheet states with no raw key, clipping or overflow. #1176 production What's New captures cover exact current catalog content at 390px/1× and 320px/DPR2 plus retained expanded injected content at 320px/2× text scale. #1181's 39 Candidate A/B/C captures cover exact contextual-help catalog English across every topic, including required 320px/2× surfaces, reachable Close and focus-after-close, with no raw key, clipping or overflow. Existing 48dp/action/focus semantics were unchanged. Broader pseudolocale expansion, locale formatting and accessible translated labels remain unproven.
- Owner: completed audit authority [#409](https://github.com/tommytang213/Settleora/issues/409). `L10N-D1-014` is ready through #1168/PR #1169, `L10N-D1-001` through #1171/PRs #1172-#1174, bounded `L10N-D1-021` through #1176/PRs #1177-#1178, and bounded `L10N-D1-022` through #1181/PRs #1182-#1183. Remaining separately bounded findings are `002`/`003`/`004`/`011`/`018`/`023`/`026`; #973/`019` retains typed dynamic notification-template arguments. The row stays `partial`: broad Dart application copy and formatting remain incomplete, no multilingual or Traditional Chinese runtime exists, and #975 retains final native device/platform acceptance. #301 owns components, not localization.
...
Completed focused issues: [#1092](https://github.com/tommytang213/Settleora/issues/1092) (bundled version notes), [#1093](https://github.com/tommytang213/Settleora/issues/1093) (static contextual help), and [#1096](https://github.com/tommytang213/Settleora/issues/1096) (setup persistence and truthful server-connection feedback). Remaining new authority/follow-up issue: [#1094](https://github.com/tommytang213/Settleora/issues/1094)
