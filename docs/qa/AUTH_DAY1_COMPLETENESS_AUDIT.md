...
| `REC-AUTH-MFA-SIGNIN-001` | Decision: `docs-planning` / `docs-only` / `docs/qa/**`; later runtime and contract use the same canonical auth and OpenAPI triples above; each client uses its separate platform lane. |
