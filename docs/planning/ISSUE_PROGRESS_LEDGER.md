...
- Twenty-five branch-rendered captures cover every entry and open sheet, plus setup close/reopen/focus and 320px/2× long-copy scrolling. Paths and SHA-256 values are recorded in [Issue #1093 evidence](../qa/evidence/issue-1093/README.md). Shared heading/button semantics, non-duplicative launcher labels and 48dp targets are covered; #975 retains native screen-reader/device acceptance.
