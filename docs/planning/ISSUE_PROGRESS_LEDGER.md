...
- The canonical inventory has **37 rows**: `implemented` 2, `partial` 18, `unavailable` 12, `blocked` 5, `superseded` 0. Current runtime credit includes shell/reset completion; bill/group/settlement/profile/payment/notification/report readouts; export; staged import confirmation; backup package/download; restore preview/confirmation metadata; and sync/local-status readout. Protected source paths remain unreachable because the shell supplies no credential; generated methods are not UI or authority.
- Thirty-five gaps are deduplicated into 18 execution packets. Existing-owner reuse: #965/#776 auth/security, #344/#402 bills/revisions, #966 files/privacy, #399 groups/dashboard, #400 friends/direct sharing/temporary participants, #969/#353 settlements, #395 profile/payment, #973 notifications, #977/#405/#404 reports/reconciliation, #971/#406/#361 sync/import/backup/restore, #365 recurring and #975 final acceptance. Focused new-child recommendations include the source-evidenced settings/Day 1 experience-mode boundary only after live duplicate search; none is runnable merely by appearing in the audit.
