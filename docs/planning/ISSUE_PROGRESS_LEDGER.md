...
- No package/lockfile, dependency/framework, API/runtime, OpenAPI/generated-client, auth/session/security behavior, password reset, notification resolver/provider, money/settlement/payment calculation, date/time/number/plural/collation, server presentation, schema/migration, storage/file/privacy, OCR, sync/import/restore, deployment/CI/config, secret, Figma/reference or translated-resource change was made.
