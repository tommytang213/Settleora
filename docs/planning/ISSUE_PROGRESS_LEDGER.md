...
- Pre-hygiene checkpoint: **OPEN**; close after this same-task ledger/evidence merge, final reviewed-blob proof and #372 reconciliation. No linked Project item was present. Native device/screen-reader acceptance is not claimed.
