...
- The canonical inventory has **42 rows**: `implemented` 2, `partial` 19, `unavailable` 14, `blocked` 7, `superseded` 0. Current runtime credit includes shell/reset completion; bill/group/settlement/profile/payment/notification/report readouts; export; staged import confirmation; backup package/download; restore preview/confirmation metadata; and sync/local-status readout. Protected source paths remain unreachable because the shell supplies no credential; generated methods are not UI or authority.
- Forty gaps are deduplicated into 23 execution packets. Existing-owner reuse includes #965/#776 auth/security, #344/#402/#967 bills/revisions, #966/#421 files/privacy and privacy modes, #399 groups/dashboard, #400 friends/direct sharing/temporary participants, #969/#353 settlements, #395 profile/payment, #973 notifications, #977/#405/#404 reports/reconciliation, #971/#406/#361 sync/import/backup/restore, #365 recurring, #412 experience modes, #1094 announcements and #975 final acceptance. New-child recommendations for bundled What’s New, contextual help and product-safe identifier/copy cleanup passed live duplicate search; none is runnable merely by appearing in the audit.
