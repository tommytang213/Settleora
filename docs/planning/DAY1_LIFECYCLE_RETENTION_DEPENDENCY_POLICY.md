...
| `SYN-MEM-02` guests/historical/local people; `MEM-CHOICE-008..010`, `012`, `017` | Group/identity/authz owner; `RC-A/B/E/X`. | Stable placeholder/provenance, payer/split/settlement references, claim/link consent/conflict, local/import copies and authorization. | Historical identity stays stable; no implied account or role. Same membership gates; PKT-02/17/18. |
| `SYN-AUTH-01` sessions/refresh/password; `AUTH-LC-CHOICE-002`, `010`, `013` | Auth/security owner; active material `RC-C`, bounded safe lineage `RC-A/B/E/X`; reusable secrets are never evidence. | Session/family/credential lineage, revocation/replay, expiry usability versus stored state, audit-save/commit result, lockout and unknown outcome. | No cleanup from expiry/revocation alone. `AUTH:G-RET/G-PRIV/G-DEST`; PKT-04. |
