...
| `FILE-LC-CHOICE-006` — How are persisted export versus backup packages distinguished within `export_file`, encrypted, expired, downloaded, and copy-disposed? | Sync/import/export/restore, storage, privacy/vault and backup recovery. | Current exports stream; backup is readiness/preview-only; no stored-package relationship, expiry, encryption, download-copy, or disposition runtime exists. | Owner-only, no stored-package claim, no automatic disposal. | #406/#971/#724/#966; `FILE-LC-GATE-001`, `002`, `003`, `005`, `006`, `008`. | Stored export/backup generation, download, expiry, recovery and copy-disposition acceptance. |
