...
- [Receipt OCR review apply policy](RECEIPT_OCR_REVIEW_APPLY_POLICY.md): design gate for a future user-triggered mutating apply operation from saved receipt OCR review data into safe bill draft data.
