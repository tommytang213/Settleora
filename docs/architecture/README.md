...
- [Auth credentials, sessions, and audit design](AUTH_CREDENTIALS_SESSIONS_AUDIT_DESIGN.md): future credential storage, session metadata, passkey/MFA direction, auth audit records, retention, and non-goals before sensitive auth schema or runtime implementation.
