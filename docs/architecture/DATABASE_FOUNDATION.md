...
- Broader confirmed residual credit/waiver finalization beyond the first receiver residual confirmation endpoint, balance projection caches or writes beyond the current read-only endpoint, approvals, status history, and audit records beyond the current schema foundation.
