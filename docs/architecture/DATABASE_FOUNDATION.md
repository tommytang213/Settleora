...
- Settlement residual runtime beyond the internal policy decision foundation, balance projection caches or writes beyond the current read-only endpoint, approvals, status history, and audit records beyond the current schema foundation.
