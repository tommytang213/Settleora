...
Credential creation creates a local password credential for an existing auth account. It is not account registration, invitation acceptance, password reset, login, or token issuance.
