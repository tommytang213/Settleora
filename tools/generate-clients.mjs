...
const webOutputPath = process.env.SETTLEORA_CLIENT_WEB_OUTPUT_PATH ?? "packages/client-web/src/generated";
const dartOutputPath = process.env.SETTLEORA_CLIENT_DART_OUTPUT_PATH ?? "packages/client-dart/lib/generated";
