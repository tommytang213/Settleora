...
function summarizeOperationalIteration(iteration = {}, run = {}) {
  ...
  return sanitize({
    ...
    review: {
      ...
      ciHead: iteration.autoMerge?.checks?.headSha || iteration.autoMerge?.checks?.expectedHeadSha || null,
      scannerStatus: iteration.autoMerge?.scanners?.status || null,
      scannerHead: iteration.autoMerge?.scanners?.headSha || iteration.autoMerge?.scanners?.expectedHeadSha || null,
