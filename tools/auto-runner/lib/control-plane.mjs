...
function summarizeOperationalIteration(iteration = {}, run = {}) {
  ...
  return sanitize({
    ...
    review: {
      ...
      githubCodexHead: iteration.autoMerge?.githubCodexReview?.headSha || iteration.autoMerge?.expectedHeadSha || null,
      ciStatus: iteration.autoMerge?.checks?.ok === true ? "pass" : iteration.autoMerge?.checks?.status || null,
      ciHead: iteration.autoMerge?.checks?.headSha || iteration.autoMerge?.expectedHeadSha || null,
      scannerStatus: iteration.autoMerge?.scanners?.status || null,
      scannerHead: iteration.autoMerge?.scanners?.headSha || iteration.autoMerge?.expectedHeadSha || null,
