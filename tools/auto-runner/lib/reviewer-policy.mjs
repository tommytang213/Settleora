...
const workflowPathPatterns = Object.freeze([/^AGENTS\.md$/, /^tools\/auto-runner(?:\/|$)/, /^docs\/workflow(?:\/|$)/]);
...
function isWorkflowPolicyDomain(domain) {
  return ["AGENTS.md", "workflow-docs-tooling", "docs/workflow", "docs/planning", "docs/qa", "tools/auto-runner"].includes(domain);
}
