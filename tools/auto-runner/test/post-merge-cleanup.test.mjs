...
test("normal merged-task path creates and persists exact recovery lineage only after target tree acceptance and hygiene", () => {
  ...
  const context = { taskKey: "20260723-1007", runId: "context-fallback-must-not-win", sessionLifecycle: { sessions: { current: "recovery-run-947:session-2" } }, issue: { number: 947 }, branchName: "feature/auto-947-cleanup", pr: { headRefName: "feature/auto-947-cleanup", baseRefName: "main", url: "https://github.com/owner/repo/pull/949" }, expectedOriginMainSha: base, recoveryState: { taskKey: "20260723-1007", run: { runId: "recovery-run-947" }, issue: { number: 947 }, branch: { name: "feature/auto-947-cleanup", baseSha: base, currentHeadSha: source }, mutationMarkers: { branch_ownership_created: { [`feature/auto-947-cleanup:${base}`]: { target: "feature/auto-947-cleanup", correlation: base } } } }, validation: { passed: true, headSha: source, baseSha: base }, externalReview: { status: "pass" }, review: { verdict: { verdict: "approve" } } };
