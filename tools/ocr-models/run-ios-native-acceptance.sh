...
__attribute__((used, constructor)) static void settleora_require_network_interposer(void) {
...
grep -Fx 'ios_runner_anchor_in_link_invocation=absent' <<< "$link_diagnostic" >/dev/null
