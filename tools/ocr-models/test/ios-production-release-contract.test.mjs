...
test("canonical wrapper fails closed around projection, locks, package inspection, and signing", () => {
  ...
  assert.match(resourceInventoryLoop,
    /Frameworks\/GoogleDataTransport\.framework\/GoogleDataTransport_Privacy\.bundle\/\*\|Frameworks\/GoogleUtilities\.framework\/GoogleUtilities_Privacy\.bundle\/PrivacyInfo\.xcprivacy\|Frameworks\/GTMSessionFetcher\.framework\/GTMSessionFetcher_Core_Privacy\.bundle\/Info\.plist\|Frameworks\/GTMSessionFetcher\.framework\/GTMSessionFetcher_Core_Privacy\.bundle\/PrivacyInfo\.xcprivacy\|Frameworks\/FBLPromises\.framework\/FBLPromises_Privacy\.bundle\/Info\.plist\|Frameworks\/FBLPromises\.framework\/FBLPromises_Privacy\.bundle\/PrivacyInfo\.xcprivacy\|Frameworks\/MLKitTextRecognition\.framework\/LatinOCRResources\.bundle\/\*/);
  assert.match(resourceInventoryLoop,
  ...
  assert.equal(matchesNestedBundle('Frameworks/GoogleUtilities.framework/GoogleUtilities_Privacy.bundle/Info.plist'), 'reject');
