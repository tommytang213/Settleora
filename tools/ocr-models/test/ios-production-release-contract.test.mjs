...
test("canonical wrapper fails closed around projection, locks, package inspection, and signing", () => {
  ...
  assert.equal(matchesNestedBundle('Frameworks/GoogleToolboxForMac.framework/GoogleToolboxForMac_Logger_Privacy.bundle/Info.plist'), 'reject');
