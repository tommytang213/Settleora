...
test("native semantic binding covers the exact provider execution path", () => {
  ...
  const expected = [
    ...
    "apps/mobile/android/app/src/debug/kotlin/com/example/mobile/ReceiptOcrBuildVariantHooks.kt",
    "apps/mobile/android/app/src/profile/kotlin/com/example/mobile/ReceiptOcrBuildVariantHooks.kt",
    "apps/mobile/android/app/src/release/kotlin/com/example/mobile/ReceiptOcrBuildVariantHooks.kt",
    ...
    "apps/mobile/android/app/src/main/kotlin/com/example/mobile/ocr/ReceiptOcrFailureClassifier.kt",
    ...
    "apps/mobile/ios/Runner/PaddleOCR/Engine/CTCDecoder.swift",
    "apps/mobile/ios/Runner/PaddleOCR/Engine/DBPostProcess.swift",
    "apps/mobile/ios/Runner/PaddleOCR/Engine/DetectionEngine.swift",
    "apps/mobile/ios/Runner/PaddleOCR/Engine/EncodedImageCodec.swift",
    "apps/mobile/ios/Runner/PaddleOCR/Engine/InferenceConfig.swift",
    "apps/mobile/ios/Runner/PaddleOCR/Engine/OCRParameterResolver.swift",
    "apps/mobile/ios/Runner/PaddleOCR/Engine/OpenCVDBBridge.h",
    "apps/mobile/ios/Runner/PaddleOCR/Engine/OpenCVDBBridge.mm",
    "apps/mobile/ios/Runner/PaddleOCR/Engine/OpenCVImageBridge.h",
    "apps/mobile/ios/Runner/PaddleOCR/Engine/OpenCVImageBridge.mm",
    "apps/mobile/ios/Runner/PaddleOCR/Engine/PDBPolygonOffsetBridge.h",
    "apps/mobile/ios/Runner/PaddleOCR/Engine/PDBPolygonOffsetBridge.mm",
    "apps/mobile/ios/Runner/PaddleOCR/Engine/Preprocessing.swift",
    "apps/mobile/ios/Runner/PaddleOCR/Engine/QuadTextCrop.swift",
    "apps/mobile/ios/Runner/PaddleOCR/Engine/RecPreprocessor.swift",
    "apps/mobile/ios/Runner/PaddleOCR/ReceiptDocumentOrientation.swift",
    "apps/mobile/ios/Runner/PaddleOCR/ReceiptOcrOrdering.swift",
    "apps/mobile/ios/Runner/PaddleOCR/SettleoraORTSessionManager.swift",
    "apps/mobile/ios/Runner/PaddleOCR/SettleoraOcrModels.swift",
    "apps/mobile/ios/Runner/PaddleOCR/SettleoraPaddleOcrEngine.swift",
    "apps/mobile/ios/Runner/PaddleOCR/ThirdParty/Clipper1/clipper.cpp",
    "apps/mobile/ios/Runner/PaddleOCR/ThirdParty/Clipper1/clipper.hpp",
    "apps/mobile/ios/Runner/Runner-Bridging-Header.h",
    "apps/mobile/ios/Runner/SettleoraReceiptOcrPlugin.swift",
  ].sort();
