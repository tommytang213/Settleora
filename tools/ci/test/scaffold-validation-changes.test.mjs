...
for (const [filename, expected] of [
  ...
  ['tools/release/day1-release-identity-cli.mjs', { docs: false, full: true, mobile: true, ios: true, web: true }],
  ['tools/release/day1-release-identity.mjs', { docs: false, full: true, mobile: true, ios: true, web: true }],
  ['tools/release/sealed_android_verifier.py', { docs: false, full: true, mobile: true, ios: true, web: false }],
