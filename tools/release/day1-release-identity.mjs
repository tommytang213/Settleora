...
function collectAndroid(repoRoot, input, source) {
  ...
  assertKeys(provenance.toolchainMutationGuard, ['algorithm', 'flutterExcludedTransientBases', 'pubExcludedBuildPaths', 'gradleWrapperLockPaths', 'gradleKotlinDslTransientBases', 'prefetchSourceGeneratedPaths', 'sourceGeneratedPaths', 'sealedGeneratedInputPaths', 'sealedGradleExecutableCachePaths', 'runtimeGradleMutablePaths', 'outputsCapturedBeforeGuardExit', 'queueOverflowFailsClosed'], 'Android build provenance toolchain mutation guard');
