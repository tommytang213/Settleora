...
function collectAndroid(repoRoot, input, source) {
  ...
  const expectedRuntimeGradleMutablePaths = ['.tmp', `caches/${guardedGradleVersion ?? ''}`, 'caches/CACHEDIR.TAG', 'caches/build-cache-1', 'caches/gc.properties', 'caches/jars-9', 'caches/journal-1', 'caches/keyrings', 'caches/modules-2', 'caches/transforms-4', 'android', 'daemon', 'kotlin-profile', 'native', 'notifications', 'workers', `wrapper/${guardedWrapperLock}`];
