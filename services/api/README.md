...
- `POST /api/v1/settlements/{settlementId}/payments` exposes debtor-authored same-currency payment claims with full and partial payment support and overpayment rejection.
