...
internal static class PasswordResetPublicOriginPolicy
{
...
internal static class PasswordResetLinkPathPolicy
{
    public static bool IsSafeRelativePath(string? resetLinkPath)
    {
        if (string.IsNullOrWhiteSpace(resetLinkPath))
        {
            return false;
        }

        var path = resetLinkPath.Trim();
