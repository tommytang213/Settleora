...
{
    /// <inheritdoc />
    public partial class AddOcrNeedsReviewNotificationRuntime : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddCheckConstraint(
                name: "ck_user_notifications_subject_type",
                table: "user_notifications",
                sql: "subject_type IN ('expense_bill', 'settlement_request', 'settlement_payment', 'recurring_bill_occurrence', 'sync_operation', 'receipt_ocr_review')");
        }
